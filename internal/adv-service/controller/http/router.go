...
func SetupRoutes(authenticator *authenticate.Authenticator, advUsecase *usecaseAdv.AdvUsecase) *mux.Router {
	r := mux.NewRouter()

	r.Use(middleware.LogMiddleware)

	advRoutes := handlerAdv.SetupAdvRoutes(authenticator, advUsecase)
